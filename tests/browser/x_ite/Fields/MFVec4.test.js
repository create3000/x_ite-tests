...
for (const [typeName, MFVec4, SFVec4] of arrays)
{
   ...
   {
      const a = new MFVec4 (new SFVec4 (1,2,3,4), new SFVec4 (5,6,7,8));

      expect (MFVec4 .from (a) .equals (a)) .toBe (true);
      expect (MFVec4 .fromArray (a .flat ()) .equals (a)) .toBe (true);
   });
   ...
   test .concurrent ("shrinkToFit", () =>
   {
      ...
      expect (field .equals (new MFVec4 (new SFVec4 (1, 2, 3, 4)))) .toBe (true);

      field .length = 2;
      expect (field .shrinkToFit ()) .toHaveLength (8);
      expect (field) .toHaveLength (2);
      expect (field .equals (new MFVec4 (new SFVec4 (1, 2, 3, 4), new SFVec4 ()))) .toBe (true);
   });
   ...
   {
      const a = new MFVec4 (new SFVec4 (1, 2, 3, 4), new SFVec4 (5, 6, 7, 8), new SFVec4 (9, 10, 11, 12));
   ...
   test .concurrent ("fromString", () =>
   {
      ...
      a .fromString ("[1 2 3 4, 2 3 4 5]", s);
   ...
   test .concurrent ("fromVRMLString", () =>
   {
      ...
      a .fromVRMLString ("[1 2 3 4, 2 3 4 5]", s);
   ...
   test .concurrent ("fromXMLString", () =>
   {
      ...
      a .fromXMLString ("1 2 3 4, 2 3 4 5", s);
   ...
   {
      const a = new MFVec4 ();
      const b = new MFVec4 (new SFVec4 (1,2,3,4));
      const c = new MFVec4 (new SFVec4 (1,2,3,4), new SFVec4 (5,6,7,8));
