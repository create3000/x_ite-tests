...
for (const [typeName, MFVec3, SFVec3] of arrays)
{
   ...
   test .concurrent ("get1Value", () =>
   {
      ...
      field .push (new SFVec3 ());
      field .push (new SFVec3 ());

      expect (field) .toHaveLength (2);
      expect (field [0]) .toBeInstanceOf (SFVec3);
      expect (field [1]) .toBeInstanceOf (SFVec3);
   ...
   test .concurrent ("shrinkToFit", () =>
   {
      ...
      expect (field .equals (new MFVec3 (new SFVec3 (1, 2, 3)))) .toBe (true);

      field .length = 2;
      expect (field .shrinkToFit ()) .toHaveLength (6);
      expect (field) .toHaveLength (2);
      expect (field .equals (new MFVec3 (new SFVec3 (1, 2, 3), new SFVec3 ()))) .toBe (true);
   });
...
;
      ...
      const n = new MFVec3 (new SFVec3 (1,2,3), new SFVec3 (4,5,6), new SFVec3 (7,8,9), new SFVec3 (10,11,12));

      expect (n .splice (-2) .equals (new MFVec3 (new SFVec3 (7,8,9), new SFVec3 (10,11,12)))) .toBe (true);
   ...
   test .concurrent ("toString", () =>
   {
      ...
      const c = new MFVec3 (new SFVec3 (1,2,3), new SFVec3 (5,6,7));
