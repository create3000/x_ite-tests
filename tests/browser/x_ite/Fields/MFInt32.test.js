...
test .concurrent ("constructor static methods", () =>
{
   ...
   expect (MFInt32 .fromArray (a .flat ()) .equals (a)) .toBe (true);
});
...
test .concurrent ("set1Value", () =>
{
   ...
   field [2] = 2;
   expect (field) .toHaveLength (3);
   expect (field .equals (new MFInt32 (1, 0, 2))) .toBe (true);
});
...
test .concurrent ("shrinkToFit", () =>
{
   ...
   expect (field) .toHaveLength (2);
   expect (field .equals (new MFInt32 (1, 2))) .toBe (true);

   field .length = 4;
   expect (field .shrinkToFit ()) .toHaveLength (4);
   expect (field) .toHaveLength (4);
   expect (field .equals (new MFInt32 (1, 2, 0, 0))) .toBe (true);
});
