...
test .concurrent ("constructor", () =>
{
   ...
   expect ((field = new MFTime (), field [0]))                .toBe (undefined);
   ...
   expect ((new MFTime ()) [0]) .toBe (undefined);
});
...
test .concurrent ("set1Value", () =>
{
   ...
   field [2] = 2;
   expect (field) .toHaveLength (3);
   expect (field .equals (new MFTime (1, -1, 2))) .toBe (true);
});
...
test .concurrent ("shrinkToFit", () =>
{
   ...
   expect (field) .toHaveLength (2);
   expect (field .equals (new MFTime (5, 6))) .toBe (true);

   field .length = 4;
   expect (field .shrinkToFit ()) .toHaveLength (4);
   expect (field) .toHaveLength (4);
   expect (field .equals (new MFTime (5, 6, -1, -1))) .toBe (true);
});
