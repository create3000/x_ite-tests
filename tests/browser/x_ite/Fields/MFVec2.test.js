...
for (const [typeName, MFVec2, SFVec2] of arrays)
{
   ...
   {
      const a = new MFVec2 (new SFVec2 (1,2), new SFVec2 (5,6));

      expect (MFVec2 .from (a) .equals (a)) .toBe (true);
      expect (MFVec2 .fromArray (a .flat ()) .equals (a)) .toBe (true);
   });
   ...
   test .concurrent ("get1Value", () =>
   {
      ...
      field .push (new SFVec2 ());
      field .push (new SFVec2 ());

      expect (field) .toHaveLength (2);
      expect (field [0]) .toBeInstanceOf (SFVec2);
      expect (field [1]) .toBeInstanceOf (SFVec2);
      ...
      expect (field [2]) .toBeInstanceOf (SFVec2);
   });
   ...
   test .concurrent ("set1Value", () =>
   {
      ...
      field [0] = new SFVec2 (1,2);
      field [2] = new SFVec2 (5,6);
      expect (field) .toHaveLength (3);
      expect (field .equals (new MFVec2 (new SFVec2 (1,2), new SFVec2 (), new SFVec2 (5,6)))) .toBe (true);
   });
   ...
   test .concurrent ("shrinkToFit", () =>
   {
      ...
      expect (field .equals (new MFVec2 (new SFVec2 (1, 2)))) .toBe (true);

      field .length = 2;
      expect (field .shrinkToFit ()) .toHaveLength (4);
      expect (field) .toHaveLength (2);
      expect (field .equals (new MFVec2 (new SFVec2 (1, 2), new SFVec2 ()))) .toBe (true);
   });
   ...
   test .concurrent ("constructor", () =>
   {
      ...
      expect ((new MFVec2 ()) [0]) .toBe (undefined);
   });
   ...
   test .concurrent ("splice", () =>
   {
      ...
      const n = new MFVec2 (new SFVec2 (1, 2), new SFVec2 (5, 6), new SFVec2 (9, 10), new SFVec2 (13, 14));

      expect (n .splice (-2) .equals (new MFVec2 (new SFVec2 (9, 10), new SFVec2 (13, 14)))) .toBe (true);
      expect (n .equals (new MFVec2 (new SFVec2 (1, 2), new SFVec2 (5, 6)))) .toBe (true);
   });
   ...
   test .concurrent ("enumerate single", () =>
   {
      ...
      enumerate (properties, new MFVec2 (new SFVec2 ()) [0]);
   });
