...
test .concurrent ("get1Value", () =>
{
   ...
   expect (field [0]) .toBeTypeOf ("number");
   expect (field [1]) .toBeTypeOf ("number");
   ...
   expect (field [2]) .toBeTypeOf ("number");
});
...
test .concurrent ("set1Value", () =>
{
   ...
   field [2] = 2;
   expect (field) .toHaveLength (3);
   expect (field .equals (new MFFloat (1, 0, 2))) .toBe (true);
});
...
test .concurrent ("shrinkToFit", () =>
{
   ...
   expect (field) .toHaveLength (2);
   expect (field .equals (new MFFloat (1, 2))) .toBe (true);

   field .length = 4;
   expect (field .shrinkToFit ()) .toHaveLength (4);
   expect (field) .toHaveLength (4);
   expect (field .equals (new MFFloat (1, 2, 0, 0))) .toBe (true);
});
...
test .concurrent ("splice", () =>
{
   ...
   const n = new MFFloat (1, 2, 3, 4);

   expect (n .splice (-2) .equals (new MFFloat (3, 4))) .toBe (true);
   expect (n .equals (new MFFloat (1, 2))) .toBe (true);
});
