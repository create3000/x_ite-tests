...
`));
   ...
   expect (() => externproto .name          = undefined) .toThrow (Error);
   expect (() => externproto .loadState     = undefined) .toThrow (Error);
   expect (() => externproto .isExternProto = undefined) .toThrow (Error);
   expect (() => externproto .urls          = undefined) .toThrow (Error);
   expect (() => externproto .fields        = undefined) .toThrow (Error);
...
"${new URL ("files/proto.x3d", import.meta.url)}"
`);
