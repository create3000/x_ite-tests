...
test ("lowerBound", () =>
{
   ...
   expect (Algorithm .lowerBound (a, 0, a .length, -1))  .toBe (0);
   expect (Algorithm .lowerBound (a, 0, a .length, 0))   .toBe (0);
   expect (Algorithm .lowerBound (a, 0, a .length, 0.5)) .toBe (1);
   expect (Algorithm .lowerBound (a, 0, a .length, 1))   .toBe (1);
   expect (Algorithm .lowerBound (a, 0, a .length, 1.5)) .toBe (2);
   expect (Algorithm .lowerBound (a, 0, a .length, 2))   .toBe (2);
   expect (Algorithm .lowerBound (a, 0, a .length, 2.5)) .toBe (3);
   expect (Algorithm .lowerBound (a, 0, a .length, 3))   .toBe (3);
   expect (Algorithm .lowerBound (a, 0, a .length, 3.5)) .toBe (4);
   expect (Algorithm .lowerBound (a, 0, a .length, 4))   .toBe (4);
   expect (Algorithm .lowerBound (a, 0, a .length, 4.5)) .toBe (5);
   expect (Algorithm .lowerBound (a, 0, a .length, 5))   .toBe (5);
...
test ("upperBound", () =>
{
   ...
   expect (Algorithm .upperBound (a, 0, a .length, -1))  .toBe (0);
   expect (Algorithm .upperBound (a, 0, a .length, 0))   .toBe (1);
   expect (Algorithm .upperBound (a, 0, a .length, 0.5)) .toBe (1);
   expect (Algorithm .upperBound (a, 0, a .length, 1))   .toBe (2);
   expect (Algorithm .upperBound (a, 0, a .length, 1.5)) .toBe (2);
   expect (Algorithm .upperBound (a, 0, a .length, 2))   .toBe (3);
   expect (Algorithm .upperBound (a, 0, a .length, 2.5)) .toBe (3);
   expect (Algorithm .upperBound (a, 0, a .length, 3))   .toBe (4);
   expect (Algorithm .upperBound (a, 0, a .length, 3.5)) .toBe (4);
   expect (Algorithm .upperBound (a, 0, a .length, 4))   .toBe (5);
   expect (Algorithm .upperBound (a, 0, a .length, 4.5)) .toBe (5);
